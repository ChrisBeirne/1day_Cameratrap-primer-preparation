...
link-citations: yes
description: "Materials for the one day 'Primer to camera trap data management and analysis' course"
---
 
# Preparing for the course

In order to prepare for the one day "Primer to camera trap data management and analysis" course. You must:
...
**If you already have R**  please update your R client so that it is on the latest version 4.4.0. Checkout the [installR package](https://www.r-project.org/nosvn/pandoc/installr.html) to do this directly from the terminal.
...
### Other packages
Whilst not necessary for the one day course - we also use these packages in the three day version of this course. 
